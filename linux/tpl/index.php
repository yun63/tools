...
<input type="submit" name="UpdateDataBtn" id="UpdateDataBtn" value="单表导入" />&nbsp;&nbsp;&nbsp;&nbsp;<input type="text" id="inputTxt"  name="inputTxt" />
  ...
  <p>
  <a href = "import_all.php"><input type="button" name="UpdateDataAll" id="UpdateDataAll" value="全部导入" /></a>
  </p>
...
if(isset($_POST['inputTxt'])&&$_POST['inputTxt']!=null)
{
	...
	$url = "svn://192.168.1.128/tpl";
	$options = " --username yun63 --password 123456 --non-interactive --no-auth-cache ";
	echo "</br>";
